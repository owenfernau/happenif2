...
class ProposeGroup extends React.Component {
  constructor(props) {
    super(props);
    // this.state = {};
  ...
  render() {
    return (<div className="ProposeGroup">
      <h3>Setup your new group</h3>
      ...
      <form onSubmit={this.handleSubmit}>
        ...
        <Button type="submit" bsStyle="success">Setup Group</Button>
      </form>
    </div>);
  }
}

ProposeGroup.propTypes = {
  // prop: PropTypes.string.isRequired,
};

export default ProposeGroup;
